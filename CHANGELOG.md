...
- Tasks can be linked to a plan, and the plan's progress follows their completion.
...
### Fixed
<!-- Bug fixes go here -->
- Creating a plan, idea or decision from an AI session now works instead of silently doing nothing.
